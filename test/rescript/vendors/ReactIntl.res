...
module Intl = {
  ...
  @get external messages: t => dict<string> = "messages"
  @get external defaultLocale: t => string = "defaultLocale"
  @get external defaultFormats: t => {..} = "defaultFormats"
  @send external formatDate: (t, Date.t) => string = "formatDate"
  @send
  external formatDateToParts: (t, Date.t) => array<part> = "formatDateToParts"
  @send
  external formatDateWithOptions: (t, Date.t, dateTimeFormatOptions) => string = "formatDate"
  @send
  external formatDateWithOptionsToParts: (t, Date.t, dateTimeFormatOptions) => array<part> =
    "formatDateToParts"
  @send external formatTime: (t, Date.t) => string = "formatTime"
  @send
  external formatTimeToParts: (t, Date.t) => array<part> = "formatTimeToParts"
  @send
  external formatTimeWithOptions: (t, Date.t, dateTimeFormatOptions) => string = "formatTime"
  @send
  external formatTimeWithOptionsToParts: (t, Date.t, dateTimeFormatOptions) => array<part> =
    "formatTimeToParts"
  @send
  ...
  let make = (
    ...
    <FormattedTimeParts value ?month ?hour ?minute ?second ?timeZone ?hour12>
      {(~formattedTimeParts) => {
        ...
        `${hours.value}${separator->Option.getOr(sep.value)}${minutes.value}`->React.string
      }}
    </FormattedTimeParts>
  }
}
